<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasBasicas/Principal.master" AutoEventWireup="true" CodeFile="NovedadesConsultaV2.aspx.cs" Inherits="UsuarioRegistracion" %>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="ibox-content m-b-sm border-bottom h5">
                        ...
                        <asp:LinkButton ID="btnDescargarArchivos" runat="server" Visible="false" class="btn btn-w-m btn-primary m-b;" OnClick="btnDescargarArchivos_Click">
