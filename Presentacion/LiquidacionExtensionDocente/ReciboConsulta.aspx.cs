...
public partial class LiquidacionExtensionDocente : System.Web.UI.Page
{
    ...
    private void EstablecerTituloFormulario()
    {
        if (this.Master != null)
        {
            this.Master.TituloDelFormulario = "Consulta de Recibo de Sueldo de Extensión Horaria Docente";
        }
    }
    ...
    Ha ocurrido un problema. Por favor, inténtelo de nuevo más tarde.
    </div>";
    }
