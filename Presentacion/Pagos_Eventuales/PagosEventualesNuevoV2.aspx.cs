...
public partial class UsuarioRegistracion : System.Web.UI.Page
{
    ...
    {
        // Implementar lógica para registrar el error (por ejemplo, escribir en un archivo de log o base de datos).
    }
    ...
    private void DisplayErrorMessage(Exception ex)
    {
        lblMensajeError.Text = "<div class='alert alert-danger alert-dismissable'>" +
            ...
            "EXCEPTION:<br>" + (ex.InnerException != null ? ex.InnerException.Message : "N/A") + "<br><br>" +
            "TRACE:<br>" + ex.StackTrace + "<br><br>" +
            "TARGET:<br>" + ex.TargetSite +
            "</div>";
    }
