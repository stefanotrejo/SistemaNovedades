        ...
        try
        {
            ...
            if (Session["EstadoLiquidacion"].ToString() != "")
            {
                /*
                 ...
                 3- Se elimin� la liquidacion
                 4- Se abri� la liquidacion
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    protected void btnGenerarArchivos_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // === GENERACI�N DEL ARCHIVO DE RESUMEN DE FILAS ===
            GenerarResumenDeArchivos(rutaDestino);

            lblMensajeError.Text = FuncionesUtiles.MensajeExito("Archivos generados con �xito");
        }
        catch (Exception oError)
        {
            lblMensajeError.Text = @"<div class=""alert alert-danger alert-dismissable"">
...
MESSAGE:<br>" + oError.Message + "<br><br>EXCEPTION:<br>" + oError.InnerException + "<br><br>TRACE:<br>" + oError.StackTrace + "<br><br>TARGET:<br>" + oError.TargetSite +
    ...
    private void GenerarResumenDeArchivos(string ruta)
    {
        try
        {
            ...
            {
                resumen.AppendLine();
                resumen.AppendLine("Suspensi�n y multa:");
    ...
    private int ContarFilasDbf(string rutaArchivoOriginal)
    {
        ...
        try
        {
            // Copia temporal como nombre.dbf v�lido
