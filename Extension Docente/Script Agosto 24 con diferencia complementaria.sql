...
SELECT 	@mesanioPruebasAge = '08/24'
...
exec [ExtensionDocente.Guardar_En_Historico] '08', '24', 65, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '08', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 65, 0,0,0
