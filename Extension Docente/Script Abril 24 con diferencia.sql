...
--UPDATE agentes_extdoc_diferencia_saldo_abril set monto_destino_rem_descontado = 0.00
--UPDATE agentes_extdoc_diferencia_saldo_abril set monto_origen_rem_descontar = 0.00
