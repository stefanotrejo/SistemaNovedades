...
update 
	#agentes_filtrados
	set IMP_521 = IMP_521 * 0.5 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 

update 
	#agentes_filtrados
	set IMP_522 = IMP_522 * 0.5 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 
...
--exec [ExtensionDocente.Eliminar_En_Historico] '03', '25', 109 
