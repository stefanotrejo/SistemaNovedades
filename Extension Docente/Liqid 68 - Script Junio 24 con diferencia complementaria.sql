...
SELECT 	@mesanioPruebasAge = '06/24'
...
exec [ExtensionDocente.Guardar_En_Historico] '06', '24', 70, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '06', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 70, 0,0,0
