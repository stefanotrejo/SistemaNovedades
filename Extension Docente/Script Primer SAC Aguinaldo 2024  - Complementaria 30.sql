...
update 
	#aguinaldo
	set haberConAporte_sac = convert(numeric(18,2), haberConAporte_sac) * 0.3 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #aguinaldo t1 

update 
	#aguinaldo
	set haberSinAporte_sac = convert(numeric(18,2), haberSinAporte_sac) * 0.3 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #aguinaldo t1 
...
exec [ExtensionDocente.Guardar_En_Historico] '13', '24', 59, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] 'S1', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 59, 0,0,0
