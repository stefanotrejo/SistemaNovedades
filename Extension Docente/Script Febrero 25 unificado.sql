-- SCRIPT PARA UNIFICAR LIQUIDACION ORIGINAL Y COMPLEMENTARIA FEBRERO 25

delete from [agentes_extension_docente_febrero25_unificado]


INSERT INTO [dbo].[agentes_extension_docente_febrero25_unificado]
           ([age_id]
           ,[NroCOntrol]
           ,[PlantaTipo]
           ,[tipo_planta_OP]
...
SELECT * from agentes_extension_docente_febrero25_unificado

begin tran t1

UPDATE 
	[agentes_extension_docente_febrero25_unificado]
SET
...
FROM 
	[agentes_extension_docente_febrero25_unificado] t1
...
where liq_id = 106
and NroCOntrol = 38002743

select * from agentes_extension_docente_historico
where liq_id = 107
and NroCOntrol = 38002743

select top 5 * from agentes_extension_docente_febrero25_unificado	
where NroCOntrol = 38002743
