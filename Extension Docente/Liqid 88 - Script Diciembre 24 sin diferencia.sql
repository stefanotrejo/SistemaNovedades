...
SELECT 	@mesanioPruebasAge = '12/24'
...
exec [ExtensionDocente.Guardar_En_Historico] '12', '24', 88, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '12', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 88, 0,0,0
