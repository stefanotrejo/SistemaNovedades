...
agentes_extdoc_diferencia_0323
...
SELECT 	@mesanioPruebasAge = '11/23'
...
UPDATE agentes_extdoc_diferencia_0323 set monto_destino_rem_descontado = null
UPDATE agentes_extdoc_diferencia_0323 set monto_destino_norem_descontado = null
...
FROM
	...
	INNER JOIN agentes_extdoc_diferencia_0323 t2
...
-- PARCIAL 2879 / 2970
select * from agentes_extdoc_diferencia_0323
...
-- NO LOS ENCONTRÓ 310 / 308
select * from agentes_extdoc_diferencia_0323
where saldo_norem is null
AND CONVERT(numeric (18,2),monto_origen_norem_descontar) > 0 

-- AGENTES A DESCONTAR ORIGINALMENTE -- 5642 / 5642
select * from agentes_extdoc_diferencia_0323  t1
where 	
...
-- TOTAL DESCUENTOS GENERAL -> $20.173.580,19 / $19.792.652,56
SELECT  				
...
FROM  
	...
	LEFT JOIN agentes_extdoc_diferencia_0323 t3
...
FROM  
 ...
 select  NroCOntrol from agentes_extdoc_diferencia_0323 
...
from agentes_extdoc_diferencia_0323 t1
