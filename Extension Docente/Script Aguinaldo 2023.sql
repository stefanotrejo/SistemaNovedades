...
SET 
	...
	IMP_664 = (CASE WHEN OSPLAD > 3			 
					THEN (haberConAporte_sac * (OSPLAD - 3) * 0.015)
					ELSE 0 
					END)
...
INSERT INTO 
	...
	(NroCOntrol, PlantaTipo, agrupamiento, tramo, apertura, cuil, LugarPago, Escuela, Juris, Prog, SubP, Actividad, fuente,dias_trabajados, haberSinAporte, haberConAporte, total_haberes,
	total_descuentos, total_liquido, C01, I01, C02, I02, C03, I03, C04, I04, C05, I05, C06, I06, C07, I07, C08, I08 )
