...
SELECT 	@mesanioPruebasAge = '12/23'
...
UPDATE agentes_extdoc_diferencia_0423 set monto_destino_rem_descontado = null
UPDATE agentes_extdoc_diferencia_0423 set monto_destino_norem_descontado = null
...
FROM
	...
	INNER JOIN agentes_extdoc_diferencia_0423 t2
...
-- AGENTES A DESCONTAR ORIGINALMENTE -- 5603 / XX
select * from agentes_extdoc_diferencia_0423  t1
where 	
...
from agentes_extdoc_diferencia_0423 t1
