...
WHERE 
	...
	AND (
			...
			OR NroCOntrol in (
				...
				,'38282584'
				,'38272063'
				,'38863291' -- AGREGAR 15.5.23
				)
		)	
			AND t1.NroCOntrol NOT IN 
									(   
									 '38357295' -- SACAR 15.5.23
									,'38265472' -- SACAR 15.5.23
									,'38511323' -- SACAR 15.5.23
									,'38278695' -- SACAR 15.5.23
									,'38449953' -- SACAR 15.5.23
									)	
