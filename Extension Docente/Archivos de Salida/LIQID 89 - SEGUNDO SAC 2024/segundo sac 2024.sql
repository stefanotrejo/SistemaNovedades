...
WHERE
	liq_id in (
	select id from LiquidacionExtensionDocente
	where definitiva = 1		
	and mes_referencia >= 06
	and anio_referencia = 24
...
select * from #aguinaldo
where ageId = 18522265

select * from agentes_extension_docente_historico
where age_id = 18522265

select * from PruebasAge
where NuevoAgeId1 = 18522265
...
exec [ExtensionDocente.Guardar_En_Historico] '14', '24', 89, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] 'S2', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 89, 0,0,0
