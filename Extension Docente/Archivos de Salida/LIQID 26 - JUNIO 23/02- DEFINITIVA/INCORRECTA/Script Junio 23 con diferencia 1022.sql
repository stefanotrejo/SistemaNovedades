...
SELECT 	@mesanioPruebasAge = '06/23'
...
select * from agentes_extdoc_diferencia_1022
...
SET 
	...
	UPDATE agentes_extdoc_diferencia_1022 set monto_destino_rem_descontado = null
	UPDATE agentes_extdoc_diferencia_1022 set monto_destino_norem_descontado = null


---------------- ACTUALIZA DIFERENCIAS DESCONTADAS ----------------
UPDATE 
	agentes_extdoc_diferencia_1022
SET 
...
FROM
	...
	INNER JOIN agentes_extdoc_diferencia_1022 t2
...
-- 114
select * from agentes_extdoc_diferencia_1022  t1
...
select t2.IMP_522, t1.monto_origen_norem_descontar, t1.monto_destino_norem_descontado from agentes_extdoc_diferencia_1022 t1 
...
--	#agentes_filtrados t1
--INNER JOIN 
--	agentes_extdoc_diferencia_1022 t2
--ON  T1.numeroControl = t2.NroCOntrol
...
--SELECT t1.monto_destino_norem_descontado ,t2.* from agentes_extdoc_diferencia_1022 t1
--inner join #agentes_filtrados t2
--on t1.NroCOntrol = t2.numeroControl
...
FROM  
	...
	LEFT JOIN agentes_extdoc_diferencia_1022 t3
...
select monto_destino_norem_descontado ,* from agentes_extdoc_diferencia_1022 
...
SELECT 
	...
	SUM(
		(t1.IMP_521 + t1.IMP_522) 
			- ( t1.IMP_602 + t1.IMP_665_1 + t1.IMP_615 + t1.IMP_616 + t1.IMP_663 +t1.IMP_664 + ISNULL(t3.monto_destino_rem_descontado,0) 
			+ ISNULL(t3.monto_destino_norem_descontado,0)) 
		) AS liquido,
	-- AP EMPLEADO ANSES
	SUM (
...
exec [ExtensionDocente.Guardar_En_Historico] '06', '23', 26, 0, 0
...
select SUM (CONVERT(numeric (18,2), monto_destino_norem_descontado)) from agentes_extdoc_diferencia_1022
