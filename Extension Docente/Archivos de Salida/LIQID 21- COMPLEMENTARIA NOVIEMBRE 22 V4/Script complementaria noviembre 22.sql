...
WHERE 
	...
	AND (
			...
			OR NroCOntrol in (
				...
				,'38272063'
				,'38282584'
				,'38863291' -- nuevo pedido
				)
		)
			AND t1.NroCOntrol NOT IN ('38278695', '38449953', '38357295', '38511323', '38265472')
...
exec [ExtensionDocente.Guardar_En_Historico] '11', '22', 21, 0, 14
