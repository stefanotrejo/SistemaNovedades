-- SCRIPT PARA UNIFICAR LIQUIDACION ORIGINAL Y COMPLEMENTARIA JUNIO 24 

delete from [agentes_extension_docente_junio24_unificado]


INSERT INTO [dbo].[agentes_extension_docente_junio24_unificado]
           ([age_id]
           ,[NroCOntrol]
           ,[PlantaTipo]
           ,[tipo_planta_OP]
...
UPDATE 
	[agentes_extension_docente_junio24_unificado]
SET
...
FROM 
	[agentes_extension_docente_junio24_unificado] t1
...
select * from [agentes_extension_docente_junio24_unificado]
