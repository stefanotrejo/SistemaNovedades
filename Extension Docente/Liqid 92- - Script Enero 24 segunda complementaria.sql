...
WHERE 
	...
	-- EXPTE 2025-00692313-GDESDE-CGE
	AND t1.NroCOntrol in (
	'38275655',
	'38829124',
	'38120842',
	'38871312',
	...
	--				)
	--AND NOT EXISTS (	
	--	SELECT * FROM agentes_extensi1968on_docente_historico t5
...
exec [ExtensionDocente.Guardar_En_Historico] '01', '24', 92, 0, 0
...
exec [ExtensionDocente.ArchivoRectificativaV2] 92, 0,0,0
