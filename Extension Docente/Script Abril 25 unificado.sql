-- SCRIPT PARA UNIFICAR LIQUIDACION ORIGINAL Y COMPLEMENTARIA ABRIL 25 --

DELETE FROM [agentes_extension_docente_abril25_unificado];

select * from [agentes_extension_docente_abril25_unificado]

-- Insertar base: liq_id = 114
INSERT INTO [dbo].[agentes_extension_docente_abril25_unificado]
...
SELECT * FROM agentes_extension_docente_historico WHERE liq_id IN (113,114) AND NroCOntrol = 38002743;
select * from agentes_extension_docente_abril25_unificado where NroCOntrol = 38002743

BEGIN TRAN t1;

rollback tran t1

------ INICIO SUMA LIQUIDACIÓN 113 ----- 
UPDATE t1
SET
...
FROM agentes_extension_docente_abril25_unificado t1
...
-- NORMALIZACIÓN
UPDATE agentes_extension_docente_abril25_unificado
SET
