...
update 
	#agentes_filtrados
	set IMP_521 = IMP_521 * 0.44 -- SE PAGA EL 45% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 

update 
	#agentes_filtrados
	set IMP_522 = IMP_522 * 0.44 -- SE PAGA EL 45% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 
...
exec [ExtensionDocente.Guardar_En_Historico] '03', '25', 108, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '03', '25'

exec [ExtensionDocente.ArchivoRectificativaV2] 108, 0,0,0
