...
select * from #agentes_filtrados
where IMP_521_original > 0
and IMP_522_original > 0

begin tran t1

update 
	#agentes_filtrados
	set IMP_521 = IMP_521 - t2.I01
...
where NroCOntrol = '38141791'
and mes = 01 and anio = 24

select * from #agentes_filtrados 
WHERE IMP_521 < 0 and IMP_522 < 0
...
select * from #agentes_filtrados
where IMP_521 = 0 or IMP_522 = 0
and numeroControl = '38890701'

select IMP_521, IMP_522 from #agentes_filtrados
where numeroControl = '38156885'
...
SELECT  							
    ...
    + CAST (dbo.RellenarTextoIzquierda(replace(cast(0 AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOT. HAB. SIN APORTE
	...
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(convert(decimal (18,2), t1.IMP_521) 
		+ (convert(decimal (18,2),0)) AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOT. HAB.
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(convert(decimal (18,2), t1.IMP_602)
			...
			+ ISNULL(convert(decimal (18,2), null),'000000000') 
			+ ISNULL(convert(decimal (18,2), null), '000000000')
	...
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(
			  (convert(decimal (18,2), t1.IMP_521) + (convert(decimal (18,2),0))) -- total hab.
			- (
...
SELECT  							
	...
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(0 AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOT. HAB. CON APORTE
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(convert(decimal (18,2), 0) 
		+ (convert(decimal (18,2),t1.IMP_522)) AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOT. HAB.
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(convert(decimal (18,2), 0)
			+ (convert(decimal (18,2),0)) + (convert(decimal (18,2),0)) + (convert(decimal (18,2),0)) 
	...
	+ '000000000' -- SALARIO	
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(
			  (convert(decimal (18,2), 0) + (convert(decimal (18,2),t1.IMP_522))) -- total hab.
			- (
					 ISNULL(convert(decimal (18,2), null),'000000000') -- 601
...
SELECT  				
	...
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(convert(decimal (18,2), t1.IMP_602)
			+ (convert(decimal (18,2),t1.imp_615)) + (convert(decimal (18,2),t1.imp_616)) + (convert(decimal (18,2),t1.imp_663)) 
			+ (convert(decimal (18,2),t1.IMP_664)) + convert(decimal (18,2), t1.IMP_665_1)  
			+ ISNULL(convert(decimal (18,2), 0),'000000000') 
			+ ISNULL(convert(decimal (18,2), 0), '000000000')
			AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOTAL DESCUENTOS	
	+ CAST(t2.PlantaTipo AS VARCHAR(1))  -- PLANTA
	+ '000000000' -- SALARIO	
	+ CAST (dbo.RellenarTextoIzquierda(replace(cast(
			...
			- (
					 ISNULL(convert(decimal (18,2), 0),'000000000') -- 601
					+ convert(decimal (18,2), t1.IMP_602) 
					+ convert(decimal (18,2), t1.IMP_615) 
					+ convert(decimal (18,2), t1.IMP_616) 					
					+ convert(decimal (18,2), t1.IMP_663) 
					+ convert(decimal (18,2), t1.IMP_664)
					+ convert(decimal (18,2), t1.IMP_665_1) 								
					+ ISNULL(convert(decimal (18,2), 0),'000000000') -- 746
				) 
				 -- tot desc. 
			AS decimal(18,2)),'.',''),'0',9) AS VARCHAR(9)) -- RELLENO + TOT LIQ.		
	+ CAST (dbo.RellenarTextoIzquierda(t2.FechaIngreso,'0',6) AS VARCHAR(6)) -- RELLENO + FECHA INGRESO			
...
-- 6461
 ...
 select * from #agentes_filtrados
 where numeroControl = '56006454'

 select * from #agentes_filtrados 
 where numeroControl = '38000275'

 select * from agentes_extension_docente_historico
 where mes = 02 and anio = 24
 and NroCOntrol = '38000275'
