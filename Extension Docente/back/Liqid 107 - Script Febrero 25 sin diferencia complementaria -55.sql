...
SELECT 	@mesanioPruebasAge = '02/25'
...
where conCodigo = 517 -- NO SE LIQUIDA POR PEDIDO DE MARIO 5/06/24
...
update 
	#agentes_filtrados
	set IMP_521 = IMP_521 * 0.55 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 

update 
	#agentes_filtrados
	set IMP_522 = IMP_522 * 0.55 -- SE PAGA EL 30% POR CUESTIONES PRESUPUESTARIAS
from #agentes_filtrados t1 
...
exec [ExtensionDocente.Guardar_En_Historico] '02', '25', 107, 0, 0

--exec [ExtensionDocente.Eliminar_En_Historico] '02', '25', 106 

exec [ExtensionDocente.Archivo_Ministerio] '02', '25'

exec [ExtensionDocente.ArchivoRectificativaV2] 107, 0,0,0
