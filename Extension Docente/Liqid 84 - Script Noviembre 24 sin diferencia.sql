...
SELECT 	@mesanioPruebasAge = '11/24'
...
exec [ExtensionDocente.Eliminar_En_Historico] '11', '24', 86
...
exec [ExtensionDocente.Guardar_En_Historico] '11', '24', 86, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '11', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 86, 0,0,0
