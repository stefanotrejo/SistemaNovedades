...
SELECT 	@mesanioPruebasAge = '07/24'
...
exec [ExtensionDocente.Guardar_En_Historico] '07', '24', 67, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '07', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 67, 0,0,0
