...
SELECT 
	...
	AS total_haberes,
		REPLICATE('0', 9- len(ltrim(CAST(replace(cast(convert(decimal (18,2), t1.IMP_602) 
		+ convert(decimal (18,2), t1.IMP_665_1) + (convert(decimal (18,2),t1.imp_615)) + (convert(decimal (18,2),t1.imp_616)) 
		+ (convert(decimal (18,2),t1.imp_663)) + (convert(decimal (18,2),t1.IMP_664)) 		 
		 as decimal(18,2)),'.','') AS VARCHAR(9))))) -- RELLENO TOTAL DESCUENTOS
		...
		+ (convert(decimal (18,2),t1.IMP_664)))
		 as decimal(18,2)),'.','') AS VARCHAR(9)) -- TOTAL DESCUENTOS
	AS total_descuentos,
