...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_febrero24_unificado_filtrado -- 6593
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_marzo24_unificado_filtrado -- 6532
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_mayo24_unificado -- 6483
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_junio24_unificado -- 6457
...
select distinct liq_id from agentes_extension_docente_historico t1
...
exec [ExtensionDocente.Guardar_En_Historico] '13', '24', 58, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] 'S1', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 58, 0,0,0
