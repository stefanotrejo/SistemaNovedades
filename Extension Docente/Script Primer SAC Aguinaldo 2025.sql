...
INSERT INTO 
	#pre_aguinaldo -- (000 filas afectadas)
	(
	[NroCOntrol]  ,
	[PlantaTipo]  ,
	[agrupamiento]  ,
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_historico t1 -- 18324 
WHERE
	liq_id in (
	91, -- enero 25
	116, -- mayo 25
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_febrero25_unificado -- 6168
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_marzo25_unificado -- 6151
...
SELECT 
	...
	age_id
FROM 
	agentes_extension_docente_abril25_unificado -- 6125
...
UPDATE 
	#aguinaldo
SET 
	haberConAporte_sac = convert(numeric (18,2), haberConAporte) * dias_trabajados,
	haberSinAporte_sac  = convert(numeric (18,2),haberSinAporte) * dias_trabajados


UPDATE
	#aguinaldo
SET
	haberConAporte_sac = convert(numeric(18,2), haberConAporte_sac)/100,
	haberSinAporte_sac = convert(numeric(18,2), haberSinAporte_sac)/100
...
UPDATE 
	#aguinaldo
SET 
	haberConAporte_sac = convert(numeric(18,2), haberConAporte_sac)/180,
	haberSinAporte_sac = convert(numeric(18,2), haberSinAporte_sac)/180


UPDATE 
	#aguinaldo
SET 
	haberConAporte_sac = convert(numeric(18,2), haberConAporte_sac)/2,
	haberSinAporte_sac = convert(numeric(18,2), haberSinAporte_sac)/2
...
select top 5 NroCOntrol, haberConAporte_sac, haberSinAporte_sac  from #aguinaldo



--update 
--	#aguinaldo
--	set haberConAporte_sac = convert(numeric(18,2), haberConAporte_sac) * 0.7 -- SE PAGA EL 70% POR CUESTIONES PRESUPUESTARIAS
--from #aguinaldo t1 

--update 
--	#aguinaldo
--	set haberSinAporte_sac = convert(numeric(18,2), haberSinAporte_sac) * 0.7 -- SE PAGA EL 70% POR CUESTIONES PRESUPUESTARIAS
--from #aguinaldo t1 
...
UPDATE
	#aguinaldo
SET
	haberConAporte_sac = dbo.RellenarTextoIzquierda(replace(cast(haberConAporte_sac AS decimal(18,2)),'.',''),'0',9),
	haberSinAporte_sac = dbo.RellenarTextoIzquierda(replace(cast(haberSinAporte_sac AS decimal(18,2)),'.',''),'0',9)
...
select * from #pre_aguinaldo where NroCOntrol = 38000262

SELECT top 10 * from #aguinaldo 
where NroCOntrol = 38000262
...
SET tipoPlanta =  (CASE 
		...
		WHEN (t2.LugarPago IN (27101, 28104, 28514, 29107) 
			...
			OR t2.LugarPago IN (56294) -- agregado el 27.12.24
		...
		WHEN t2.LugarPago IN (27116, 28112, 28522, 29115) 
			...
			OR t2.LugarPago IN (56151) -- agregado el 18.12.24									 
...
exec [ExtensionDocente.Guardar_En_Historico] '13', '25', 119, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] 'S1', '25'

exec [ExtensionDocente.ArchivoRectificativaV2] 119, 0,0,0
