...
SELECT 	@mesanioPruebasAge = '08/22'
...
exec [ExtensionDocente.Guardar_En_Historico] '09', '22', 19, 0, 0
...
exec [ExtensionDocente.Eliminar_En_Historico] '09', '22', 19

select PlantaTipo, * from PruebasAge
where NroCOntrol in (
'38001491',
'38272063',
'38282584',
...
select * from agentes_extension_docente
	...
	SELECT * 
		...
		select * from Concepto_historico