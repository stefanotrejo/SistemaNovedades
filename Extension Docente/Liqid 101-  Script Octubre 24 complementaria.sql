...
SELECT 	@mesanioPruebasAge = '10/24'
...
exec [ExtensionDocente.Guardar_En_Historico] '10', '24', 101, 0, 0

--exec [ExtensionDocente.Eliminar_En_Historico] '06','24',96
...
exec [ExtensionDocente.Archivo_Ministerio] '10', '24'

exec [ExtensionDocente.ArchivoRectificativaV2] 101, 0,0,0
