...
SELECT 	@mesanioPruebasAge = '08/25'
...
--update 
--	#agentes_filtrados
--	set IMP_521 = IMP_521 * 0.5 -- SE PAGA EL 45% POR CUESTIONES PRESUPUESTARIAS
--from #agentes_filtrados t1 

--update 
--	#agentes_filtrados
--	set IMP_522 = IMP_522 * 0.5 -- SE PAGA EL 45% POR CUESTIONES PRESUPUESTARIAS
--from #agentes_filtrados t1 
...
SET tipoPlanta =  (CASE 
		...
		WHEN t2.LugarPago IN (27116, 28112, 28522, 29115) 
			...
			OR t2.LugarPago IN (56174) -- agregado el 3.9.25				
...
where 
 ...
 select * from PruebasAge
 where NuevoAgeId1 in (19391639, 19391641)


 select * from PruebasAge
 where NuevoAgeId1 = 18624820

 select * from LugarPago
 where lpaCodigo = 56294

 SELECT * from PruebasAge
 where NuevoAgeId1 = 18536303

 select * from LugarPago
 where lpaCodigo = '56151'
...
--exec [ExtensionDocente.Eliminar_En_Historico] '12', '24', 88
...
SElect * from agentes_extension_docente_historico
where mes = 08 and anio = 25

exec [ExtensionDocente.Guardar_En_Historico] '08', '25', 122, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '08', '25'

--exec [ExtensionDocente.Eliminar_En_Historico] '02', '25', 107

exec [ExtensionDocente.ArchivoRectificativaV2] 122, 0,0,0
