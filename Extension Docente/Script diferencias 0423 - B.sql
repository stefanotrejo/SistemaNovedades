...
agentes_extdoc_diferencia_0423
*/
...
SELECT T1.IMP_521 AS REM_ACTUAL, T1.IMP_522 AS NOREM_ACTUAL, t2.I01 AS REM_HIST, t2.I02 AS NO_REM_HIST,
t2.I01 - T1.IMP_521 AS DIF_REM, T1.numeroControl
...
SELECT T1.IMP_521 AS REM_ACTUAL, T1.IMP_522 AS NOREM_ACTUAL, t2.I01 AS REM_HIST, t2.I02 AS NO_REM_HIST,
t2.I02 - T1.IMP_522 AS DIF_NOREM
from #agentes_filtrados T1
inner join agentes_extension_docente_historico t2
on T1.numeroControl = t2.NroCOntrol
where t2.liq_id in (17)  -- TODOS LOS LIQID DE ABRIL
...
SET
	...
	monto_origen_norem_descontar = (CASE WHEN convert(decimal (18,2), incorrecto.I02) >= convert(decimal (18,2), correcto.I02)
									...
									END)
FROM
	agentes_extdoc_diferencia_0423 correcto
