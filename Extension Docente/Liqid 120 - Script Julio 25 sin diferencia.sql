...
SELECT 	@mesanioPruebasAge = '07/25'
...
exec [ExtensionDocente.Guardar_En_Historico] '07', '25', 121, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '07', '25'

--exec [ExtensionDocente.Eliminar_En_Historico] '02', '25', 107

exec [ExtensionDocente.ArchivoRectificativaV2] 121, 0,0,0
