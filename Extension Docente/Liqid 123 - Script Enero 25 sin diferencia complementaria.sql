...
SELECT 	@mesanioPruebasAge = '01/25'
...
exec [ExtensionDocente.Guardar_En_Historico] '01', '25', 123, 0, 0

exec [ExtensionDocente.Archivo_Ministerio] '01', '25'

exec [ExtensionDocente.ArchivoRectificativaV2] 123, 0,0,0
